...
agent_communication:
  ...
  - agent: "main"
    message: "🔧 MATCH PARSING SYSTEM IMPROVED: Fixed all bugs in scheduler and parser. Switched from PostgreSQL to MongoDB completely. Added real parsing for all sports: Football (Football-Data API), Baseball (MLB StatsAPI), Hockey (TheSportsDB), Esports (mock data for now). System now parses 21 actual matches daily at 12:00 МСК. All endpoints working correctly."
  - agent: "testing"
